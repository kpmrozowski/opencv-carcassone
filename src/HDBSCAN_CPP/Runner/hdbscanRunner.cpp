...
#include <HDBSCAN_CPP/Distance/EuclideanDistance.hpp>
#include <HDBSCAN_CPP/Distance/ManhattanDistance.hpp>
#include <HDBSCAN_CPP/HdbscanStar/hdbscanAlgorithm.hpp>
